...
POSITIONS = [
    # 2026-08-04 卖出200股@650.2, 实现损益 -33,996円(-20.7%); 剩余1200股均价不变(移动平均法)
    {"code": "1579.T", "name": "日经Bull2倍ETF (1579)", "qty": 1200, "cost": 820.18, "kind": "现物"},
    # 已平仓: 4751 CyberAgent 现物100株@1,379 → 2026-07-09 @1,534卖出, 实现损益 +15,500円(+11.2%)
    # 已平仓: 7186 横滨金融集团 现物100株@1,781.5 → 2026-08 卖出(成交价待补)
    {"code": "8306.T", "name": "三菱UFJ (8306)", "qty": 100, "cost": 3135.00, "kind": "现物"},
    {"code": "9501.T", "name": "东京电力 (9501)", "qty": 100, "cost": 689.00, "kind": "现物"},
    # 已平仓: 4063 信越化学 信用买100株@7,155 → 2026-07-09 @7,258卖出, 实现损益 +10,300円(+1.4%)
    ...
    # 已平仓: 7012 川崎重工 信用买100株@2,859.5 → 2026-08 平仓(成交价待补)
...
MARGIN_DEPOSIT = 1202108   # 受入保证金基准(2026-07-10由用户维持率31.16%反推校准;历史:32.41→1338696,49.99→1414272,39.76→1290705,27.81→1161828)
